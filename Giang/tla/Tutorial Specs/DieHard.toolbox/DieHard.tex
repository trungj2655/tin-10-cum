...
\@x{ {\EXTENDS} Integers}%
\@pvspace{8.0pt}%
\@x{ {\VARIABLES} small ,\, big}%
\@pvspace{8.0pt}%
\@x{ TypeOK \.{\defeq} \.{\land} small \.{\in} 0 \.{\dotdot} 3}%
\@x{\@s{56.14} \.{\land} big\@s{10.88} \.{\in} 0 \.{\dotdot} 5}%
\@pvspace{8.0pt}%
\@x{ Init \.{\defeq} \.{\land} big\@s{10.88} \.{=} 0}%
\@x{\@s{35.70} \.{\land} small \.{=} 0}%
\@pvspace{8.0pt}%
\@x{ FillSmall \.{\defeq} \.{\land} small \.{'} \.{=} 3}%
\@x{\@s{59.67} \.{\land} big \.{'}\@s{10.88} \.{=} big}%
\@pvspace{8.0pt}%
\@x{ FillBig \.{\defeq} \.{\land} big \.{'}\@s{10.88} \.{=} 5}%
\@x{\@s{49.69} \.{\land} small \.{'} \.{=} small}%
\@pvspace{8.0pt}%
\@x{ EmptySmall \.{\defeq} \.{\land} small \.{'} \.{=} 0}%
\@x{\@s{72.70} \.{\land} big \.{'}\@s{10.88} \.{=} big}%
\@pvspace{8.0pt}%
\@x{ EmptyBig \.{\defeq} \.{\land} big \.{'}\@s{10.88} \.{=} 0}%
\@x{\@s{62.72} \.{\land} small \.{'} \.{=} small}%
\@pvspace{8.0pt}%
\@x{ SmallToBig\@s{0.14} \.{\defeq} {\IF} big \.{+} small \.{\leq} 5}%
\@x{\@s{74.76} \.{\THEN} \.{\land} big \.{'}\@s{10.88} \.{=} big \.{+} small}%
\@x{\@s{106.07} \.{\land} small \.{'} \.{=} 0}%
\@x{\@s{74.76} \.{\ELSE} \.{\land} big \.{'}\@s{10.88} \.{=} 5}%
\@x{\@s{106.07} \.{\land} small \.{'} \.{=} small \.{-} ( 5 \.{-} big )}%
\@pvspace{8.0pt}%
\@x{ BigToSmall \.{\defeq} {\IF} big \.{+} small \.{\leq} 3}%
\@x{\@s{74.76} \.{\THEN} \.{\land} big \.{'}\@s{10.88} \.{=} 0}%
\@x{\@s{106.07} \.{\land} small \.{'} \.{=} big \.{+} small}%
 \@x{\@s{74.76} \.{\ELSE} \.{\land} big \.{'}\@s{10.88} \.{=} small \.{-} ( 3
 \.{-} big )}%
\@x{\@s{106.07} \.{\land} small \.{'} \.{=} 3}%
\@pvspace{8.0pt}%
