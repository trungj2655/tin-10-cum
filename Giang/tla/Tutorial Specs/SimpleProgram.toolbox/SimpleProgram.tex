...
\fl{}\moduleLeftDash\cl{ {\MODULE} SimpleProgram}\moduleRightDash\cl{}
\fl{}
\fl{ {\EXTENDS} Integers}
\fl{ {\VARIABLES} i ,\, pc}
\fl{}
 \fl{ Init}\al{5}{1}{ \.{\defeq}}\al{5}{2}{ ( pc \.{=}\@w{start} ) \.{\land} (
 i \.{=} 0 )}
\fl{}
 \fl{ Pick}\al{7}{1}{ \.{\defeq}}\al{7}{2}{ \.{\land}}\al{7}{3}{ pc}\al{7}{4}{
 \.{=}\@w{start}}
\fl{ \.{\land}}\al{8}{1}{ i \.{'}}\al{8}{3}{ \.{\in} 0 \.{\dotdot} 1000}
\fl{ \.{\land}}\al{9}{1}{ pc \.{'} \.{=}\@w{middle}}
\fl{}
 \fl{ Add1}\al{11}{1}{ \.{\defeq}}\al{11}{2}{ \.{\land}}\al{11}{3}{
 pc}\al{11}{4}{ \.{=}}\al{11}{5}{\@w{middle}}
\fl{ \.{\land}}\al{12}{1}{ i \.{'}}\al{12}{3}{ \.{=}}\al{12}{4}{ i \.{+} 1}
\fl{ \.{\land}}\al{13}{1}{ pc \.{'} \.{=}\@w{done}}
\fl{}
\fl{ Next}\al{15}{1}{ \.{\defeq} Pick \.{\lor} Add1}
\fl{}
\fl{}\bottombar\cl{}
\end{document}
